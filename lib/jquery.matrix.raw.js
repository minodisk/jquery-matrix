 ...
 * Can represent any 3D affine transformation.
 /**
 *
 * @param {Number} [m11=1] Specifies row one, column one
 * @param {Number} [m12=0] Specifies row one, column two
 * @param {Number} [m13=0] Specifies row one, column three
 * @param {Number} [m21=0] Specifies row two, column one
 * @param {Number} [m22=1] Specifies row two, column two
 * @param {Number} [m23=0] Specifies row two, column three
 * @param {Number} [m31=0] Specifies row three, column one
 * @param {Number} [m32=0] Specifies row three, column two
 * @param {Number} [m33=1] Specifies row three, column three
 * @param {Number} [tx=0]  Specifies row four, column one.
 * @param {Number} [ty=0]  Specifies row four, column two.
 * @param {Number} [tz=0]  Specifies row four, column three.
 * @constructor
 */
function Matrix4x3(m11, m12, m13, m21, m22, m23, m31, m32, m33, tx, ty, tz) {
  if (m11 instanceof Matrix4x3) {
    var m = m11
      ;
    m11 = m.m11;
    m12 = m.m12;
...
Matrix4x3.concat = function (a, b) {
  return new Matrix4x3(a).concat(b);
};
Matrix4x3.prototype.concat = function (a) {
  var m11 = this.m11
    , m12 = this.m12
    , m13 = this.m13
    , m21 = this.m21
  ...
  this.m11 = m11 * a.m11 + m12 * a.m21 + m13 * a.m31;
  this.m12 = m11 * a.m12 + m12 * a.m22 + m13 * a.m32;
  this.m13 = m11 * a.m13 + m12 * a.m23 + m13 * a.m33;

  this.m21 = m21 * a.m11 + m22 * a.m21 + m23 * a.m31;
  this.m22 = m21 * a.m12 + m22 * a.m22 + m23 * a.m32;
  this.m23 = m21 * a.m13 + m22 * a.m23 + m23 * a.m33;

  this.m31 = m31 * a.m11 + m32 * a.m21 + m33 * a.m31;
  this.m32 = m31 * a.m12 + m32 * a.m22 + m33 * a.m32;
  this.m33 = m31 * a.m13 + m32 * a.m23 + m33 * a.m33;

  // Compute the translation portion
  this.tx = tx * a.m11 + ty * a.m21 + tz * a.m31 + a.tx;
  this.ty = tx * a.m12 + ty * a.m22 + tz * a.m32 + a.ty;
  this.tz = tx * a.m13 + ty * a.m23 + tz * a.m33 + a.tz;
